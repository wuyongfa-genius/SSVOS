...
from ssvos.utils.env import collect_env
from ssvos.utils.logger import get_root_logger
...
def arg_parser():
    ...
    parser.add_argument("--log_dir", default='exps/byol')
    ...
    for e in range(start_epoch, args.epochs+1):
        ...
        if accelerator.is_main_process:
            if e % args.save_interval == 0:
                ...
                torch.save(
                    {'state_dict': model.module.state_dict(), 'epoch': e}, save_path)
